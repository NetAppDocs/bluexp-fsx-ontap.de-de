...
.Bevor Sie beginnen
Bevor Sie ein neues Volume erstellen, benötigen Sie einen aktiven https://docs.netapp.com/us-en/bluexp-setup-admin/task-creating-connectors-aws.html["Anschluss in AWS"^].
