...
Bei allgemeinen Fragen zu BlueXP oder BlueXP-Diensten können Sie mit dem Inline-Chat von BlueXP beginnen.

Bei technischen Support-Problemen im Zusammenhang mit BlueXP oder BlueXP Services können Sie über die Seriennummer des BlueXP Accounts ein NetApp Support Ticket eröffnen. Das müssen Sie link:https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/support/task-support-registration.html["registrieren Sie Ihr BlueXP-Konto"^] Um den Support zu aktivieren.
