...
--
Für die Aktivierung sind die folgenden zusätzlichen Berechtigungen erforderlich link:../use/task-manage-fsx-working-environment.html["Automatisches Kapazitätsmanagement"].
